...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_OnCreateSession_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "//\n//Callbacks for the custom delegate in MultiPlayerSessionsSubsystem;\n//\n" },
#endif
		{ "ModuleRelativePath", "Public/Menu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Callbacks for the custom delegate in MultiPlayerSessionsSubsystem;" },
#endif
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 848348847
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 88547919
	...
	UMenu::~UMenu() {}
	struct Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Plugins_MultiPlayerSessions_Source_MultiPlayerSessions_Public_Menu_h_Statics
	{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Plugins_MultiPlayerSessions_Source_MultiPlayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 2978653849U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Plugins_MultiPlayerSessions_Source_MultiPlayerSessions_Public_Menu_h_3883396863(TEXT("/Script/MultiPlayerSessions"),
