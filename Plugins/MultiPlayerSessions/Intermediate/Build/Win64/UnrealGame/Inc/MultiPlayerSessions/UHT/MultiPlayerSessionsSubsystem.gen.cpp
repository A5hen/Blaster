...
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Declare our own custom delegates for the menu class to bind callbacks to" },
#endif
	};
#endif
...
void FMultiPlayerOnDestroySessionComplete_DelegateWrapper(const FMulticastScriptDelegate& MultiPlayerOnDestroySessionComplete, bool bWasSuccessful)
{
	...
	struct Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Plugins_MultiPlayerSessions_Source_MultiPlayerSessions_Public_MultiPlayerSessionsSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Plugins_MultiPlayerSessions_Source_MultiPlayerSessions_Public_MultiPlayerSessionsSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMultiPlayerSessionsSubsystem, UMultiPlayerSessionsSubsystem::StaticClass, TEXT("UMultiPlayerSessionsSubsystem"), &Z_Registration_Info_UClass_UMultiPlayerSessionsSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiPlayerSessionsSubsystem), 2444037358U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Plugins_MultiPlayerSessions_Source_MultiPlayerSessions_Public_MultiPlayerSessionsSubsystem_h_3501225689(TEXT("/Script/MultiPlayerSessions"),
		Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Plugins_MultiPlayerSessions_Source_MultiPlayerSessions_Public_MultiPlayerSessionsSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Plugins_MultiPlayerSessions_Source_MultiPlayerSessions_Public_MultiPlayerSessionsSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
