...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ABlasterGameModeBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ABlasterGameModeBase_Statics::ClassParams = {
		...
		0,
		0x009002ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ABlasterGameModeBase_Statics::Class_MetaDataParams), Z_Construct_UClass_ABlasterGameModeBase_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_BlasterGameModeBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_BlasterGameModeBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABlasterGameModeBase, ABlasterGameModeBase::StaticClass, TEXT("ABlasterGameModeBase"), &Z_Registration_Info_UClass_ABlasterGameModeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABlasterGameModeBase), 2935511562U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_BlasterGameModeBase_h_123839111(TEXT("/Script/Blaster"),
		Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_BlasterGameModeBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_BlasterGameModeBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
