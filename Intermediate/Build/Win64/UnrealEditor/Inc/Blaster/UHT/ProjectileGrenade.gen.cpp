...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AProjectileGrenade_OnBounce_Statics::NewProp_ImpactResult = { "ImpactResult", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ProjectileGrenade_eventOnBounce_Parms, ImpactResult), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AProjectileGrenade_OnBounce_Statics::NewProp_ImpactResult_MetaData), Z_Construct_UFunction_AProjectileGrenade_OnBounce_Statics::NewProp_ImpactResult_MetaData) }; // 1891709922
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AProjectileGrenade_OnBounce_Statics::NewProp_ImpactVelocity = { "ImpactVelocity", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ProjectileGrenade_eventOnBounce_Parms, ImpactVelocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AProjectileGrenade_OnBounce_Statics::NewProp_ImpactVelocity_MetaData), Z_Construct_UFunction_AProjectileGrenade_OnBounce_Statics::NewProp_ImpactVelocity_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AProjectileGrenade_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AProjectileGrenade_OnBounce, "OnBounce" }, // 2810076164
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AProjectileGrenade_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_ProjectileGrenade_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_ProjectileGrenade_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AProjectileGrenade, AProjectileGrenade::StaticClass, TEXT("AProjectileGrenade"), &Z_Registration_Info_UClass_AProjectileGrenade, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AProjectileGrenade), 1715458841U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_ProjectileGrenade_h_2291095849(TEXT("/Script/Blaster"),
		Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_ProjectileGrenade_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_ProjectileGrenade_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
