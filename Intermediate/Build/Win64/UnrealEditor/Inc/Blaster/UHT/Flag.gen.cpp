...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFlag_Statics::NewProp_FlagMesh = { "FlagMesh", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFlag, FlagMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AFlag_Statics::NewProp_FlagMesh_MetaData), Z_Construct_UClass_AFlag_Statics::NewProp_FlagMesh_MetaData) };
	...
	template<> BLASTER_API UClass* StaticClass<AFlag>()
	{
		return AFlag::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AFlag);
	AFlag::~AFlag() {}
	struct Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Flag_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Flag_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFlag, AFlag::StaticClass, TEXT("AFlag"), &Z_Registration_Info_UClass_AFlag, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFlag), 863275744U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Flag_h_3201796686(TEXT("/Script/Blaster"),
		Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Flag_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Flag_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
