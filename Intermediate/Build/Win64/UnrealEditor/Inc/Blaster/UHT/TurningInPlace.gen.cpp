...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_Blaster_ETurningInPlace_Statics::Enum_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "TurningInPlace.h" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_TurningInPlace_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_TurningInPlace_h_Statics::EnumInfo[] = {
		{ ETurningInPlace_StaticEnum, TEXT("ETurningInPlace"), &Z_Registration_Info_UEnum_ETurningInPlace, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3625549696U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_TurningInPlace_h_1695354597(TEXT("/Script/Blaster"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_TurningInPlace_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_TurningInPlace_h_Statics::EnumInfo));
