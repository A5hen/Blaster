...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpeedPickup_Statics::NewProp_BaseSpeedBuff = { "BaseSpeedBuff", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpeedPickup, BaseSpeedBuff), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpeedPickup_Statics::NewProp_BaseSpeedBuff_MetaData), Z_Construct_UClass_ASpeedPickup_Statics::NewProp_BaseSpeedBuff_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpeedPickup_Statics::NewProp_CrouchSpeedBuff = { "CrouchSpeedBuff", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpeedPickup, CrouchSpeedBuff), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpeedPickup_Statics::NewProp_CrouchSpeedBuff_MetaData), Z_Construct_UClass_ASpeedPickup_Statics::NewProp_CrouchSpeedBuff_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpeedPickup_Statics::NewProp_SpeedBuffTime = { "SpeedBuffTime", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpeedPickup, SpeedBuffTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpeedPickup_Statics::NewProp_SpeedBuffTime_MetaData), Z_Construct_UClass_ASpeedPickup_Statics::NewProp_SpeedBuffTime_MetaData) };
	...
	ASpeedPickup::~ASpeedPickup() {}
	struct Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Pickups_SpeedPickup_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Pickups_SpeedPickup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASpeedPickup, ASpeedPickup::StaticClass, TEXT("ASpeedPickup"), &Z_Registration_Info_UClass_ASpeedPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpeedPickup), 3247494159U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Pickups_SpeedPickup_h_1829995939(TEXT("/Script/Blaster"),
		Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Pickups_SpeedPickup_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Pickups_SpeedPickup_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
