...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACasing_OnHit_Statics::NewProp_HitComponent_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACasing_OnHit_Statics::NewProp_HitComponent = { "HitComponent", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Casing_eventOnHit_Parms, HitComponent), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACasing_OnHit_Statics::NewProp_HitComponent_MetaData), Z_Construct_UFunction_ACasing_OnHit_Statics::NewProp_HitComponent_MetaData) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACasing_OnHit_Statics::NewProp_Hit = { "Hit", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Casing_eventOnHit_Parms, Hit), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACasing_OnHit_Statics::NewProp_Hit_MetaData), Z_Construct_UFunction_ACasing_OnHit_Statics::NewProp_Hit_MetaData) }; // 1891709922
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACasing_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACasing_OnHit, "OnHit" }, // 766259278
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ACasing_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACasing_Statics::NewProp_CasingMesh = { "CasingMesh", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACasing, CasingMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACasing_Statics::NewProp_CasingMesh_MetaData), Z_Construct_UClass_ACasing_Statics::NewProp_CasingMesh_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACasing_Statics::NewProp_ShellEjectionImpulse = { "ShellEjectionImpulse", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACasing, ShellEjectionImpulse), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACasing_Statics::NewProp_ShellEjectionImpulse_MetaData), Z_Construct_UClass_ACasing_Statics::NewProp_ShellEjectionImpulse_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACasing_Statics::NewProp_ShellSound = { "ShellSound", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACasing, ShellSound), Z_Construct_UClass_USoundCue_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACasing_Statics::NewProp_ShellSound_MetaData), Z_Construct_UClass_ACasing_Statics::NewProp_ShellSound_MetaData) };
	...
	ACasing::~ACasing() {}
	struct Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Casing_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Casing_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACasing, ACasing::StaticClass, TEXT("ACasing"), &Z_Registration_Info_UClass_ACasing, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACasing), 1594000922U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Casing_h_352488520(TEXT("/Script/Blaster"),
		Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Casing_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiPlayerShooter_Blaster_Source_Blaster_Weapon_Casing_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
